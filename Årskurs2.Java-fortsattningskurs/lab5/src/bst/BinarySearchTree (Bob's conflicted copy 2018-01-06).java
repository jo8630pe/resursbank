...
//		BinarySearchTree is created and the new item is stored in its root node (Step 2).
	...
	private void findPath(BinaryNode<E> n, StringBuilder sb, E e) {
		if(n != null) {
			if(n.element.equals(e)) {
				...
				sb.append('0');
				findPath(n.left,sb,e);
			}
			else {
				sb.append('1');
				findPath(n.right,sb,e);
			}
		}
		else {
	...
	public static void main(String[] args) {
		...
		//bst.printTree();
		bstv.drawTree(bst);
		System.out.println(bst.findPath(52));
		bst.rebuild();
		System.out.println(bst.findPath(52));
		System.out.println(bst.findPath(100));
